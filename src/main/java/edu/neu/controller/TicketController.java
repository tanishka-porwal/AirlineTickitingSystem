...
import edu.neu.dao.TravelTicketDAO;
import edu.neu.dao.TravellerDAO;
...
public class TicketController {
    ...
    public String emailTicket(HttpServletRequest request, TravellerDAO pdao) throws AddException {
        try {
            ...
            email.setAuthenticator(new DefaultAuthenticator("tanishkaporwal9@gmail.com", "9752484757"));
            email.setSSLOnConnect(true);
            try {
                email.setFrom("tanishkaporwal9@gmail.com");
    ...
    public String deleteTicket(HttpServletRequest request, TravellerDAO pdao, TravelTicketDAO tdao) throws AddException {
        try {
            HttpSession session = request.getSession();
            long passenger_id = ((Long) session.getAttribute("passenger_id"));
            Traveller passenger = pdao.searchTraveller(passenger_id);
